...
const ImportCSV = () => {
  ...
  const handleDownloadTemplate = () => {
    ...
    a.href = url
    a.download = 'sampleQuestion.csv' // Set the desired file name
    a.click()
  ...
  const handleCsvDrop = async (event) => {
    console.log('called inside csvDrop')
  ...
  const handleCsvDragOver = (event) => {
    event.preventDefault()
    setCsvFileDropped(true)
    console.log('called inside csvDrag over')
  }
  ...
  const validateCsvFile = (file) => {
    return new Promise((resolve, reject) => {
      if (!file) {
        ...
        console.log('fail to came inside if')
        resolve(false)
        return
      }
      ...
      reader.onload = function (e) {
        ...
        if (header === expectedHeader) {
          ...
          console.log('came inside validatCsvFile')
          resolve(true)
        } else {
          setCsvFile(null)
          setCsvFileValid(false)
