...
const EmployeeAssessment = ({onClose}) => {
    ...
    const fetchEmployee = () => {
        axios.get('https://localhost:7281/HistoryTable/HistoryDetails?roleName=Employee',{
            headers: {
                "Authorization": "Bearer " +  sessionStorage.getItem('token')
              }
        })
          ...
          >
            ...
            <form className="employeeForm">
              ...
              <TextField
                ...
                label={
                  !isInputActive2 ? "Enter Assessment ID" : "Assessment ID"
                }
                value={assessmentId}
                  ...
                  >
                    {TopicName.map((name) => (
                      <MenuItem key={name} value={name}>
                        <Checkbox
                          checked={TopicNameComma.indexOf(name.name) > -1}
                        />
              ...
              <div className="divideBox">
                <div className="questionForm">
                  ...
                  <p className="questionsPara">
                    Time alloted for a question is 60 sec.
                  </p>
                </div>
                <div>
        ...
        >
          <Box sx={modalStyle}>
            ...
            <p className="modalPara">
              The jobseeker assessment has been successfully sent through their
              respectful email id
            </p>
