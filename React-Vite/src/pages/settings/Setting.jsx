...
const Setting = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://localhost:7281/api/AssesmentData/AdminDetails', {
        headers: {
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      const response = await axios.put(
        'https://localhost:7281/api/AssesmentData/UpdatingAdminValues?id=KB2308',
        formData,
        {
          headers: {
  ...
  const handlePasswordChange = (e) => {
    ...
    if (name === 'confirmNewPassword' && value !== changePasswordData.newPassword) {
  ...
  return (
    <>
      <Navbar
        title="Settings"
        desc="View completed details of all locations and its corresponding details"
      ></Navbar>
      <div className="entire-page">
        <div className="top-logo-and-image">
          <div className="profile-image">
            <img
              src={`https://localhost:7281/Images/${formData.employeeImage}`}
        ...
        <div className="total-label">
          <div className="personal">
            <h3 style={{ fontWeight: "600" }}>Personal</h3>
            <br />
            <form>
      ...
      {isPasswordChanged && (
        <Stack>
          <Alert
            severity="success"
            sx={{ marginLeft: "850px", marginTop: "-60px", width: "15%" }}
          >
