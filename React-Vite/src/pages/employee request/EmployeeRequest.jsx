...
const EmployeeRequest = () => {
    ...
    const [rows, setRows] = useState(slicedRows);
        ...
        fetch(`https://localhost:7281/HistoryTable/AfterAdminDecision?RequestId=${requestId}`, {
            ...
            .then(async (data) => {
                ...
                if (data.success) {
                    ...
                    console.error("Error in accepting request:", data.error);
                }
            })
            .catch((error) => {
                console.log("Error:", error);
  ...
  return (
    <>
      <Navbar
        ...
        desc="View completed details of all request assessed and its corresponding details raised from employee"
      ></Navbar>
                  ...
                  <TableRow key={row.requestId}>
                    ...
                    {!isRowRemoved && !isRowRemoved2 && (
                      <TableCell sx={tablefetch} className="viewResult">
                        <p
                          className="result"
                          onClick={handleOpen(row.requestId)}
                        >
                          VIEW DETAILS
                        </p>
                      </TableCell>
                    ...
                    {!isRowRemoved && !isRowRemoved2 && (
                      <TableCell sx={tablefetch} className="viewResult">
                        <div className="decisionFlex">
                          <div
                            className="cursor tick"
                            onClick={() => handleRemoveRow(row.requestId, row)}
                          >
                            <svg
                          ...
                          <div
                            ...
                            onClick={() => handleRemoveRow2(row.requestId)}
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                            ...
                            >
                              <path
                                d="M7.5 17.76L12 13.26L16.5 17.76L17.76 16.5L13.26 12L17.76 7.5L16.5 6.24L12 10.74L7.5 6.24L6.24 7.5L10.74 12L6.24 16.5L7.5 17.76ZM12 24C10.36 24 8.81 23.685 7.35 23.055C5.89 22.425 4.615 21.565 3.525 20.475C2.435 19.385 1.575 18.11 0.945 16.65C0.315 15.19 0 13.64 0 12C0 10.34 0.315 8.78 0.945 7.32C1.575 5.86 2.435 4.59 3.525 3.51C4.615 2.43 5.89 1.575 7.35 0.945C8.81 0.315 10.36 0 12 0C13.66 0 15.22 0.315 16.68 0.945C18.14 1.575 19.41 2.43 20.49 3.51C21.57 4.59 22.425 5.86 23.055 7.32C23.685 8.78 24 10.34 24 12C24 13.64 23.685 15.19 23.055 16.65C22.425 18.11 21.57 19.385 20.49 20.475C19.41 21.565 18.14 22.425 16.68 23.055C15.22 23.685 13.66 24 12 24ZM12 22.2C14.84 22.2 17.25 21.205 19.23 19.215C21.21 17.225 22.2 14.82 22.2 12C22.2 9.16 21.21 6.75 19.23 4.77C17.25 2.79 14.84 1.8 12 1.8C9.18 1.8 6.775 2.79 4.785 4.77C2.795 6.75 1.8 9.16 1.8 12C1.8 14.82 2.795 17.225 4.785 19.215C6.775 21.205 9.18 22.2 12 22.2Z"
                                fill="#FCA5A5"
                              />
                            </svg>
                          </div>
                    ...
                    {!isRowRemoved && !isRowRemoved2 && (
                      <TableCell sx={{ border: "none", textAlign: "center" }}>
                        <p
                          className="cursor"
                          onClick={toggleDrawer("right", true, row.requestId)}
                        >
                          EDIT
                        </p>
                      </TableCell>
            ...
            <div>
              ...
              <div className="requestDetail">
                ...
                <div className="requestFlex">
                  <div className="requestFlex3 reqtop">
                    ...
                    <div className="requestInput alignCent mrgleft">
                      {getDetails.empId}
                    </div>
                  </div>
                  <div className="requestFlex3 reqtop">
                    <div className="reqColumn">Department</div>
                    <div className="requestInput alignCent mrgleft2">
                ...
                <div className="requestFlex reqtop">
                  <div className="requestFlex">
                    ...
                    <div className="requestInput alignCent mrgleft3">
                      {getDetails.name}
                    </div>
                  </div>
                  <div className="requestFlex reqtop">
              ...
              <div className="white">
                <div className="requestDetail margtopReq">
                  ...
                  <div className="requestFlex">
                    <div className="requestFlex">
                      ...
                      <div className="requestInput alignCent margleft4 assessInput">
                        {getDetails.assessmentId}
                      </div>
                    </div>
                    <div className="requestFlex">
                      <div className="reqColumn mleft">Date</div>
                      <div className="requestInput alignCent margleft5  assessInput">
                        {formatDate3(getDetails.completionOn)}
                      </div>
                    </div>
                  </div>
                  <div className="requestFlex">
                    <div className="requestFlex">
                      ...
                      <div className="requestInput2 alignCent margleft6 assessInput">
                        {renderTopics(getDetails.topicName)}
                      </div>
                    </div>
                    <div className="requestFlex2 ">
                      <div className="requestFlex mtop">
                        <div className="reqColumn">Time Allotted</div>
                        <div className="requestInput alignCent margleft7 assessInput">
                          {getDetails.timeAllotted}
                        </div>
                      </div>
                      <div className="requestFlex mtop">
                        <div className="reqColumn">Level</div>
                        <div className="requestInput alignCent margleft8 assessInput">
                          {getDetails.skillLevel}
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="proceedFlex">
                  <div className="reqCancel" onClick={handleClose}>
                    Cancel
                  </div>
                  <div
                    className="reqProceed"
                    onClick={() =>
                      handleRemoveRow(getDetails.requestId, getDetails)
                    }
                  >
                    Proceed
                  </div>
