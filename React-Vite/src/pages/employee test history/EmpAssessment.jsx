...
const postEmail = () => {
  ...
  return (
    <>
      <Navbar title="Employee Assessment Data" desc="View completed details of all assessed and its corresponding details of employee"></Navbar>
                      ...
                      <TableRow key={row.userAssessmentId}>
                        <TableCell sx={{ border: 'none', fontSize: '12px' }}>
                          <div className='flex-prop'>
                            <div className='imageDiv'><img src={`https://localhost:7281/Images/${row.employeeImage}`} className='image'></img></div>
              ...
              <div className={topicToggleclick ? "dept hidden" : "dept"} id="ques">
                ...
                {getTopic.map((topics, index) => (
                  <p key={index} className='inputPara'>
                    <input type='checkbox' className='inputEmp' value={topics} checked={selectedTopics.includes(topics)}
              ...
              <div className={skillToggleclick ? "dept hidden" : "dept"} id="ques">
                ...
                {getSkill.map((name) => (
                  <p key={name.id} className='inputPara'>
                    ...
                    <input type='checkbox' className='inputEmp' value={name.skillLevel} checked={selectedSkill === name.skillLevel}
                  ...
                  >
                    {editRow.name &&(
                        <MenuItem key={editRow.name} value={editRow.name}>
                          <Checkbox checked={personName.indexOf(editRow.name) > -1} />
