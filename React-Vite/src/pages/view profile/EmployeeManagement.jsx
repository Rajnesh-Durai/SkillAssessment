      ...
      <div className="commondiv">
        <div className="leftcards">
          <Card className="card1 py-4" sx={{ borderRadius: 3, width: "33rem" }}>
            <img
              src={`https://localhost:7281/Images/${viewprofile.employeeImage}`}
            ...
            <CardContent className="boxsize">
              ...
              <Typography variant="h5">
                {viewprofile.usersId}-{viewprofile.name}
              </Typography>
              ...
              <div className="details">
                ...
                <div className="combine">
                  <div>
                    {" "}
                    <img src={location} alt="loctaion_images" />{" "}
                  </div>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div className="combine">
                  <div>
                    <img src={phone} alt="phone_images" />
                  </div>
                  &nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <TabContext value={value}>
              ...
              <TabPanel value="1">
                {loading ? (
                  ...
                  <p className="noitems-available">
                    No Completed Test Available
                  </p>
                ) : (
                      ...
                      <CardContent className="boxsize2">
                        <div className="combine2">
                          <div>
                            ...
                            <Typography>
                              Topics :{" "}
                              <span>{completetests.topicNames + ","}</span>
                            </Typography>
                            {/* <hr /> */}
                            <br />
                            <div className="assignments">
                              <div className="times">
                                <div>
                                  <img src={clock} alt="clock_images" />
                                </div>
                                &nbsp;&nbsp;
                                <div>
                                  Created On :{" "}
                                  {formatDate2(completetests.dateOfCreation)}
                                </div>
                              </div>
                              &nbsp;&nbsp;&nbsp;&nbsp;
                              <div className="times">
                                <div>
                                  <img src={user} alt="user_images" />
                                </div>
                                &nbsp;&nbsp;
                              ...
                              <div className="times">
                                <div>
                                  <img src={clock} alt="clcks_images" />
                                </div>
                                &nbsp;&nbsp;
                                <div>
                                  Submitted On :{" "}
                                  {formatDate2(completetests.dateOfSubmission)}{" "}
                                </div>
                              </div>
                              &nbsp;&nbsp;&nbsp;&nbsp;
                              <div className="times">
                                <div>
                                  <img src={result} alt="result_images" />
                                </div>
                                &nbsp;&nbsp;
                          ...
                          <div>
                            <button
                              className="viewres"
                              onClick={handleOpen(
                                completetests.userAssessmentId
                              )}
                            >
                              {" "}
                              View Result
                        ...
                        <CardContent className="boxsize2">
                          <div className="combine2">
                            <div>
                              ...
                              <Typography>
                                Topics :{" "}
                                <span>{ongoingtest.topicNames + ","}</span>
                              </Typography>
                              {/* <hr /> */}
                              <br />
                              <div className="assignments">
                                <div className="times">
                                  ...
                                  <div>
                                    Created On :{" "}
                                    {formatDate2(ongoingtest.dateOfCreation)}
                                  </div>
                                </div>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <div className="times">
                                ...
                                <div className="times">
                                  ...
                                  <div>
                                    Submit Before :{" "}
                                    {formatDate2(ongoingtest.dateOfSubmission)}
                                  </div>
                                </div>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                              </div>
                            ...
                            <div>
                              <button className="viewres btn-disabled">
                                {" "}
                                View Details
                              </button>
                            </div>
